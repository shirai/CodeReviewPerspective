...
1. **対応方針を「技術的負債」の考え方を用いて<br>検討する**
...
- 今書いてある処理は<br><font color="yellow">「今後メンテナンスできるものか？」</font>
...
|１つの処理が担う役割（仕事量）が大きすぎないか？|予想外の箇所への影響
...
※ここは言語・フレームワーク・PJ依存が大きいので、今回は細かい解説を省略します
...
ただし、  
どんな環境でも使える普遍的な価値観を持つことで、  
言語やフレームワークの理解がより深まりより早くなる
