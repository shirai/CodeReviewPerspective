...
- 障害そのもの ではなく、<br>「修正しにくい・理解しにくい」コード
...
- 仕様・コードを覚えているうちにやる
- 担当者がいるうちにやる<br>→ 放置すると放置されっ放しになるので<br><font color="red">　なかなか直らない</font>
...
- 一応ちゃんと動いてはいる
- 同じところを修正する案件はすぐには来ない<br>→直す必要性を感じなくなり、<br>　暫定対応だったはずのコードが<br>　長生きしてしまうことがある。
